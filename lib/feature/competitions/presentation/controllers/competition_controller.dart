...
@LazySingleton()
class CompetitionController = _CompetitionControllerBase with _$CompetitionController;
...
abstract class _CompetitionControllerBase with Store {
  ...
  _CompetitionControllerBase(this._personUseCase, this._habitUseCase, this._competitionUseCase);
