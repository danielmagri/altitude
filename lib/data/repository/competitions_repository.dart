...
abstract class ICompetitionsRepository {
  ...
  Future<void> inviteCompetitor(
      String competitionId, List<String?> competitorsId);
  ...
  Future<void> acceptCompetitionRequest(
      String competitionId, Competitor competitor, Competition competition);
  Future<Competition> createCompetition(
      Competition competition, String habitText);
}
...
class CompetitionsRepository extends ICompetitionsRepository {
  ...
  CompetitionsRepository(this._memory, this._fireDatabase, this._fireAuth,
      this._sharedPref, this._fireAnalytics);
  ...
  @override
  Future<void> inviteCompetitor(
      String competitionId, List<String?> competitorsId) async {
  ...
  Future<void> removeCompetitor(Competition competition) async {
    await _fireDatabase.removeCompetitor(competition.id, _fireAuth.getUid(),
  ...
  @override
  Future<void> acceptCompetitionRequest(String competitionId,
      Competitor competitor, Competition competition) async {
  ...
  @override
  Future<Competition> createCompetition(
      Competition competition, String habitText) async {
    Competition newCompetition =
        await _fireDatabase.createCompetition(competition);

    _fireAnalytics.sendCreateCompetition(competition.title ?? '', habitText,
