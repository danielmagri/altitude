...
import 'package:altitude/common/app_logic.dart' as _i23;
...
import 'package:altitude/core/services/FireAuth.dart' as _i25;
import 'package:altitude/core/services/FireDatabase.dart' as _i26;
import 'package:altitude/core/services/FireFunctions.dart' as _i27;
import 'package:altitude/core/services/FireMenssaging.dart' as _i28;
import 'package:altitude/core/services/interfaces/i_fire_analytics.dart'
    as _i14;
import 'package:altitude/core/services/interfaces/i_fire_auth.dart' as _i24;
...
import 'package:altitude/feature/habitDetails/logic/HabitDetailsLogic.dart'
    as _i17;
import 'package:altitude/feature/home/logic/HomeLogic.dart' as _i22;
import 'package:altitude/feature/login/logic/LoginLogic.dart' as _i30;
import 'package:altitude/feature/setting/logic/SettingsLogic.dart' as _i33;
import 'package:altitude/feature/statistics/logic/StatisticsLogic.dart' as _i35;
import 'package:get_it/get_it.dart' as _i1;
import 'package:injectable/injectable.dart' as _i2;

import 'mocks/services_mocks.dart' as _i29;
...
_i1.GetIt $initGetItTest(_i1.GetIt get,
  ...
  gh.factory<_i12.IFireMessaging>(() => _i28.FireMessaging(),
      registerFor: {_service});
  gh.lazySingleton<_i21.ILocalNotification>(() => _i29.MockLocalNotification(),
      registerFor: {_service_test});
  gh.lazySingleton<_i30.LoginLogic>(() => _i30.LoginLogic());
  gh.lazySingleton<_i31.PendingCompetitionLogic>(() =>
      _i31.PendingCompetitionLogic(
          get<_i8.CompetitionUseCase>(), get<_i6.HabitUseCase>()));
  gh.lazySingleton<_i32.PendingFriendsLogic>(
      () => _i32.PendingFriendsLogic(get<_i4.PersonUseCase>()));
  gh.factory<_i4.PersonUseCase>(
      () => _i4.PersonUseCase(
          ...
          get<_i13.IFireFunctions>()),
      registerFor: {_usecase});
  gh.lazySingleton<_i33.SettingsLogic>(() => _i33.SettingsLogic(
      get<_i4.PersonUseCase>(),
      get<_i6.HabitUseCase>(),
      get<_i8.CompetitionUseCase>(),
      get<_i34.SharedPref>()));
  gh.lazySingleton<_i35.StatisticsLogic>(() =>
      _i35.StatisticsLogic(get<_i4.PersonUseCase>(), get<_i6.HabitUseCase>()));
  gh.singleton<_i23.AppLogic>(_i23.AppLogic());
  gh.singleton<_i8.CompetitionUseCase>(_i36.MockCompetitionUseCase(),
      registerFor: {_usecase_test});
  gh.singleton<_i6.HabitUseCase>(_i36.MockHabitUseCase(),
      registerFor: {_usecase_test});
  gh.singleton<_i14.IFireAnalytics>(_i37.FireAnalytics(),
      registerFor: {_service});
  gh.singleton<_i14.IFireAnalytics>(_i29.MockFireAnalytics(),
      registerFor: {_service_test});
  gh.singleton<_i24.IFireAuth>(_i29.MockFireAuth(),
      registerFor: {_service_test});
  gh.singleton<_i11.IFireDatabase>(_i29.MockFireDatabase(),
      registerFor: {_service_test});
  gh.singleton<_i13.IFireFunctions>(_i29.MockFireFunctions(),
      registerFor: {_service_test});
  gh.singleton<_i12.IFireMessaging>(_i29.MockFireMessaging(),
      registerFor: {_service_test});
  ...
  gh.singleton<_i39.MockSharedPref>(_i39.MockSharedPref(),
      registerFor: {_service_test});
  gh.singleton<_i4.PersonUseCase>(_i36.MockPersonUseCase(),
      registerFor: {_usecase_test});
