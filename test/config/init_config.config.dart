...
import 'package:altitude/common/app_logic.dart' as _i38;
...
import 'package:altitude/common/domain/usecases/habits/max_habits_usecase.dart'
    as _i37;
import 'package:altitude/common/sharedPref/SharedPref.dart' as _i32;
...
import 'package:altitude/core/services/FireAnalytics.dart' as _i40;
...
import 'package:altitude/core/services/interfaces/i_local_notification.dart'
    as _i21;
import 'package:altitude/core/services/LocalNotification.dart' as _i41;
...
import 'package:altitude/feature/home/presentation/controllers/home_controller.dart'
    as _i34;
import 'package:altitude/feature/login/logic/LoginLogic.dart' as _i28;
import 'package:altitude/feature/setting/logic/SettingsLogic.dart' as _i31;
import 'package:altitude/feature/statistics/logic/StatisticsLogic.dart' as _i33;
import 'package:get_it/get_it.dart' as _i1;
import 'package:injectable/injectable.dart' as _i2;

import 'mocks/services_mocks.dart' as _i27;
import 'mocks/shared_pref_mock.dart' as _i42;
import 'mocks/use_case_mocks.dart' as _i39;
...
_i1.GetIt $initGetItTest(_i1.GetIt get,
  ...
  gh.lazySingleton<_i28.LoginLogic>(() => _i28.LoginLogic());
  gh.lazySingleton<_i29.PendingCompetitionLogic>(() =>
      _i29.PendingCompetitionLogic(
          get<_i8.CompetitionUseCase>(), get<_i6.HabitUseCase>()));
  gh.lazySingleton<_i30.PendingFriendsLogic>(
      () => _i30.PendingFriendsLogic(get<_i4.PersonUseCase>()));
  gh.factory<_i4.PersonUseCase>(
      () => _i4.PersonUseCase(
          ...
          get<_i13.IFireFunctions>()),
      registerFor: {_usecase});
  gh.lazySingleton<_i31.SettingsLogic>(() => _i31.SettingsLogic(
      get<_i4.PersonUseCase>(),
      get<_i6.HabitUseCase>(),
      get<_i8.CompetitionUseCase>(),
      get<_i32.SharedPref>()));
  gh.lazySingleton<_i33.StatisticsLogic>(() =>
      _i33.StatisticsLogic(get<_i4.PersonUseCase>(), get<_i6.HabitUseCase>()));
  gh.lazySingleton<_i34.HomeController>(() => _i34.HomeController(
      get<_i35.GetHabitsUsecase>(),
      get<_i36.CompleteHabitUsecase>(),
      get<_i37.MaxHabitsUsecase>(),
      get<_i14.IFireAnalytics>(),
      get<_i38.AppLogic>(),
      get<_i4.PersonUseCase>(),
      get<_i8.CompetitionUseCase>()));
  gh.singleton<_i38.AppLogic>(_i38.AppLogic());
  gh.singleton<_i8.CompetitionUseCase>(_i39.MockCompetitionUseCase(),
      registerFor: {_usecase_test});
  gh.singleton<_i6.HabitUseCase>(_i39.MockHabitUseCase(),
      registerFor: {_usecase_test});
  gh.singleton<_i14.IFireAnalytics>(_i27.MockFireAnalytics(),
      registerFor: {_service_test});
  gh.singleton<_i14.IFireAnalytics>(_i40.FireAnalytics(),
      registerFor: {_service});
  ...
  gh.singletonAsync<_i21.ILocalNotification>(
      () => _i41.LocalNotification.initialize(),
      registerFor: {_service});
  gh.singleton<_i10.Memory>(_i10.Memory());
  gh.singleton<_i42.MockSharedPref>(_i42.MockSharedPref(),
      registerFor: {_service_test});
  gh.singleton<_i4.PersonUseCase>(_i39.MockPersonUseCase(),
      registerFor: {_usecase_test});
  gh.singletonAsync<_i32.SharedPref>(() => _i32.SharedPref.initialize(),
      registerFor: {_service});
  return get;
}
