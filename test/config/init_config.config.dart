...
_i1.GetIt $initGetItTest(_i1.GetIt get,
  ...
  gh.factory<_i11.IFireMessaging>(() => _i12.FireMessaging(),
      registerFor: {_service});
  gh.lazySingleton<_i13.ILocalNotification>(() => _i14.LocalNotification(),
      registerFor: {_service});
  gh.lazySingleton<_i13.ILocalNotification>(() => _i15.MockLocalNotification(),
      registerFor: {_service_test});
  gh.lazySingleton<_i16.LoginLogic>(() => _i16.LoginLogic());
  gh.lazySingleton<_i17.PendingCompetitionLogic>(() =>
      _i17.PendingCompetitionLogic(
          get<_i4.CompetitionUseCase>(), get<_i18.HabitUseCase>()));
  gh.factory<_i19.PersonUseCase>(
      () => _i19.PersonUseCase(
          ...
          get<_i21.IFireAnalytics>(),
          get<_i9.IFireFunctions>()),
      registerFor: {_usecase});
  gh.lazySingleton<_i22.SettingsLogic>(() => _i22.SettingsLogic(
      get<_i19.PersonUseCase>(),
      get<_i18.HabitUseCase>(),
      get<_i4.CompetitionUseCase>()));
  gh.lazySingleton<_i23.StatisticsLogic>(() => _i23.StatisticsLogic(
      get<_i19.PersonUseCase>(), get<_i18.HabitUseCase>()));
  gh.lazySingleton<_i24.AddFriendLogic>(
      () => _i24.AddFriendLogic(get<_i19.PersonUseCase>()));
  gh.lazySingleton<_i25.AddHabitLogic>(
      () => _i25.AddHabitLogic(get<_i18.HabitUseCase>()));
  gh.lazySingleton<_i26.CompetitionDetailsLogic>(() =>
      _i26.CompetitionDetailsLogic(
          get<_i19.PersonUseCase>(), get<_i4.CompetitionUseCase>()));
  gh.lazySingleton<_i27.CompetitionLogic>(() => _i27.CompetitionLogic(
      get<_i19.PersonUseCase>(),
      get<_i18.HabitUseCase>(),
      get<_i4.CompetitionUseCase>()));
  gh.factory<_i4.CompetitionUseCase>(
      () => _i4.CompetitionUseCase(
          ...
          get<_i21.IFireAnalytics>()),
      registerFor: {_usecase});
  gh.lazySingleton<_i28.EditHabitLogic>(
      () => _i28.EditHabitLogic(get<_i18.HabitUseCase>()));
  gh.lazySingleton<_i29.FriendsLogic>(
      () => _i29.FriendsLogic(get<_i19.PersonUseCase>()));
  ...
  gh.lazySingleton<_i32.PendingFriendsLogic>(
      () => _i32.PendingFriendsLogic(get<_i19.PersonUseCase>()));
  ...
  gh.lazySingleton<_i34.EditCueLogic>(() => _i34.EditCueLogic(
      get<_i18.HabitUseCase>(), get<_i30.HabitDetailsLogic>()));
  gh.singleton<_i4.CompetitionUseCase>(_i35.MockCompetitionUseCase(),
      registerFor: {_usecase_test});
  gh.singleton<_i18.HabitUseCase>(_i35.MockHabitUseCase(),
      registerFor: {_usecase_test});
  gh.singleton<_i21.IFireAnalytics>(_i36.FireAnalytics(),
      registerFor: {_service});
  gh.singleton<_i21.IFireAnalytics>(_i15.MockFireAnalytics(),
      registerFor: {_service_test});
  gh.singleton<_i5.IFireAuth>(_i15.MockFireAuth(),
      registerFor: {_service_test});
  gh.singleton<_i7.IFireDatabase>(_i15.MockFireDatabase(),
      registerFor: {_service_test});
  gh.singleton<_i9.IFireFunctions>(_i15.MockFireFunctions(),
      registerFor: {_service_test});
  gh.singleton<_i11.IFireMessaging>(_i15.MockFireMessaging(),
      registerFor: {_service_test});
  gh.singleton<_i20.Memory>(_i20.Memory());
  gh.singleton<_i37.MockSharedPref>(_i37.MockSharedPref(),
      registerFor: {_service_test});
  gh.singleton<_i19.PersonUseCase>(_i35.MockPersonUseCase(),
      registerFor: {_usecase_test});
  gh.singletonAsync<_i38.SharedPref>(() => _i38.SharedPref.initialize(),
      registerFor: {_service});
  return get;
}
