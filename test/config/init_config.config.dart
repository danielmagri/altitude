...
import 'package:altitude/core/services/interfaces/i_local_notification.dart'
    as _i13;
import 'package:altitude/core/services/LocalNotification.dart' as _i15;
...
_i1.GetIt $initGetItTest(_i1.GetIt get,
  ...
  gh.lazySingleton<_i13.ILocalNotification>(() => _i15.LocalNotification(),
      registerFor: {_service});
  ...
  gh.lazySingleton<_i30.HabitDetailsLogic>(() => _i30.HabitDetailsLogic(
      get<_i18.HabitUseCase>(), get<_i4.CompetitionUseCase>()));
  ...
  gh.singleton<_i18.HabitUseCase>(_i35.MockHabitUseCase(),
      registerFor: {_usecase_test});
  gh.singleton<_i21.IFireAnalytics>(_i14.MockFireAnalytics(),
      registerFor: {_service_test});
